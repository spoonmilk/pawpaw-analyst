    ...
    return (score != null && score != undefined ?
        <div className="relative size-40">
            <svg className="size-full rotate-180" viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg">
                ...
                <circle cx="18" cy="18" r="16" fill="none" className="stroke-current text-blue-600 dark:text-blue-500" strokeWidth="1.5" strokeDasharray={`${(score / 10) * 50} 100`} strokeLinecap="round"></circle>
            </svg>
